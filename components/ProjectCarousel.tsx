...
const ProjectCarousel = () => {
    ...
    const portfolioItems = [
        ...
        { id: 3, title: "An Optimistic Future", vibe: "Futuristic", description: "Landing page mockup for a personal writing project", url: "/images/projects/optimistic.jpg" },
        { id: 4, title: "Emoji Royale", vibe: "Pulpy", description: "Competitive emoji guessing game", url: "/images/projects/emojiroyale.png" },
        { id: 5, title: "BT Sport (Unofficial)", vibe: "Professional", description: "Fun remix I did of BT Sports after a frustrating real life use case", url: "/images/projects/btsport.jpg" },
        { id: 6, title: "Triviamoji", vibe: "Clean", description: "An emoji trivia game, you can play at www.triviamoji.com", url: "/images/projects/triviamoji.png" },
        { id: 7, title: "Featherbed Tales", vibe: "Fun", description: "Online self-recording service for children's stories", url: "/images/featherbed/featherbedtemp.jpg" },
        ...
        { id: 10, title: "Lifereel", vibe: "Crunchy", description: "Record documentaries about your family members", url: "/images/projects/lifereel.png" },
        { id: 11, title: "arbnco", vibe: "Data Visualisation", description: "Dashboard for carbon emissions and air quality", url: "/images/projects/arbnco.png" },
        ...
        { id: 13, title: "Logistics.io", vibe: "Professional", description: "Whitelabelled logistics solution design", url: "/images/projects/logisticsio.jpg" },
        { id: 14, title: "YouK", vibe: "Clean", description: "An online marketplace for goods made in the UK", url: "/images/projects/youk.jpg" },
        { id: 15, title: "100 Men All Men Should Know", vibe: "Sophisticated", description: "List of 100 Men who achieved great things but are relatively unknown to the public", url: "/images/projects/100men.png" },
        { id: 16, title: "Lifereel", vibe: "Tactile & Earthy", description: "Concept for a split page marketing design", url: "/images/projects/lifereel_marketing.jpg" },
    ];
