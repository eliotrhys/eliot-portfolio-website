          ...
          <h2 className="subtitle mb-5 md:mb-10 text-center">I've worked on projects in</h2>
            <div className="">
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <motion.div variants={animationItem} className="inline-flex"><a href="https://langcatfinancial.co.uk/" target="_blank" rel="noreferrer" className="area-badge bg-emerald-600 relative">💰 finance</a></motion.div>
                    ...
                    <motion.div variants={animationItem} className="inline-flex"><a href="https://github.com/eliotrhys/mystic_miriam" target="_blank" rel="noreferrer" className="area-badge bg-teal-600">🤖 AI entertainment</a></motion.div>
                </motion.div>
            </div>
