    ...
    return (
        <div className="container mx-auto px-4">
            ...
            >
                ...
                <motion.div variants={animationItem} className="bg-lime-500 border border-lime-900">
                    ...
                    <div className="p-6 pt-3">
                        ...
                        <a href="#case-studies-block" className="text-md text-white mt-6 p-4 duration-200 ease-in-out cursor-pointer bg-lime-600 hover:bg-lime-800 flex justify-center items-center">See case studies</a>
                    </div>
                </motion.div>

                <motion.div variants={animationItem} className="bg-red-500 border border-red-900">
                    <div className="p-6 pb-3">
                        <div className="text-3xl">🎨</div>
                    ...
                    <div className="p-6 pt-3">
                        ...
                        <a href="#design-block" className="text-md text-white mt-6 p-4 duration-200 ease-in-out cursor-pointer bg-red-600 hover:bg-red-800 flex justify-center items-center">See UI mockups</a>
                    </div>
                </motion.div>

                <motion.div variants={animationItem} className="bg-purple-500 border border-purple-900">
                    <div className="p-6 pb-3">
                        <div className="text-3xl">👨🏻‍💻</div>
                    ...
                    <div className="p-6 pt-3">
                        ...
                        <a href="https://github.com/eliotrhys" target="_blank" className="text-md text-white mt-6 p-4 duration-200 ease-in-out cursor-pointer bg-purple-600 hover:bg-purple-800 flex justify-center items-center">Github</a>
                    </div>
                </motion.div>


                <motion.div variants={animationItem} className="bg-amber-500 border-amber-900">
                    <div className="p-6 pb-3">
                        <div className="text-3xl">🤩</div>
                    ...
                    <div className="p-6 pt-3">
                        ...
                        <div href="" className="text-md text-white mt-6 p-4 duration-200 ease-in-out cursor-pointer flex justify-center items-center">Coming soon!</div>
                    </div>
                </motion.div>
            </motion.div>
        </div>
